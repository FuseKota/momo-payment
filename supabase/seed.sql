...
VALUES
  ...
  ('rurohan-frozen-set', 'FROZEN_FOOD', '【配送】冷凍魯肉飯セット（4食入）', 'お得な4食入りセット。ご家族やお友達とシェアして楽しめます。まとめ買いでさらにお得！', 2200, false, true, 'FROZEN', 30, '/images/rurohan-set.jpg',
    ...
    true, 2),
  ('momo-tshirt-ship', 'GOODS', '【配送】もも娘オリジナルTシャツ', 'もも娘ロゴ入りのオリジナルTシャツ。やわらかい肌触りの綿100%素材。サイズはMとLをご用意。', 3500, false, true, 'AMBIENT', 20, '/images/tshirt.jpg', NULL, true, 10),
  ...
  ('momo-sticker', 'GOODS', '【配送】もも娘ステッカーセット', 'かわいいもも娘イラストのステッカー5枚セット。防水加工で長持ち。', 500, false, true, 'AMBIENT', 100, '/images/stickers.jpg', NULL, true, 12)
